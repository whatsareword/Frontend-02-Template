...
function layout(element) {
    ...
    if (!style[mainSize]) {
        ...
        for (var i = 0; i < items.length; i++) {
            ...
            if (itemStyle[mainSize] !== null || itemStyle[mainSize] !== (void 0)) {
                elementStyle[mainStyle] = elementStyle[mainSize] + items[i][mainSize]
            }
        }
    ...
    var mainSize = elementStyle[mainSize];
    var crossSpace = 0;
    for (var i = 0; i < items.length; i++) {
        var items = items[i];
    ...
    if (itemStyle.flex) {
        ...
        if (mainSpace < itemStyle[mainSize]) {
            ...
            mainSpace = style[mainStyle];
            crossSpace = 0;
        } else {
            flexLine.push(item);
        }
        if (itemStyle[crossSize] !== null && itemStyle[crossSize] !== (void 0)) {
            crossSpace = Math.max(crossSpace, itemStyle[crossSizze]);
        }
        mainSpace -= itemStyle[mainSize];
    }
    ...
    flexLines.forEach(items => {
        ...
        for (var i = 0; i < items.length; i++) {
            ...
            if (align === 'flex-start') {
                itemStyle[crossStrart] = crossBase;
            ...
            if (align === 'center') {
                itemStyle[crossStart] = crossBase + crossSign * (lineCrossSize - itemSize[crossSize]) / 2;
                itemStyle[crossEnd] = itemStyle[crossStart] + crossSign * itemStyle[crossSize];
            }
            if (align === 'stretch') {
                itemStyle[crossStart] = crossBase;
                itemStyle[crossEnd] = crossBase + crossSign * ((itemStyle[crossSize] !== null && itemStyle[crossSize] !== (void 0)) ? itemStyle[crossStyle] : 0);
